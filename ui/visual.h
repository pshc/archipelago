...
#define load_shader(name, uniforms) _load_shader(name, &(uniforms), (_spec_##uniforms), sizeof(struct uniforms) / sizeof(unsigned int))
...
int _load_shader(const char *, void *, const char * const *, size_t);
